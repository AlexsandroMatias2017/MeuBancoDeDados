...
CREATE TABLE IF NOT EXISTS `roque`.`diario` (
  ...
  PRIMARY KEY (`iddiario`, `iddisciplina`, `idcurso`, `idavaliacao`),
...
START TRANSACTION;
USE `roque`;
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (2, 8, 21);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (2, 10, 2);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (2, 8, 3);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (4, 10, 3);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (4, 10, 4);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (4, 7, 5);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (3, 10, 7);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (3, 9, 4);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (3, 7, 11);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (3, 6, 6);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (4, 10, 14);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (4, 8, 6);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (4, 7, 7);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (2, 6, 18);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (2, 5, 19);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (3, 9, 2);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (3, 9, 3);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (6, 9, 9);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (7, 9, 6);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (7, 10, 7);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (7, 10, 10);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (5, 7, 4);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (5, 8, 5);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (5, 8, 8);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (6, 8, 5);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (6, 9, 6);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (1, 9, 1);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (1, 7, 2);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (1, 5, 3);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (1, 4, 4);
INSERT INTO `roque`.`nota_avaliacao` (`idavaliacao`, `nota`, `idaluno`) VALUES (2, 8, 1);
